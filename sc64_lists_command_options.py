...
list_of_commands = [
    ...
    ["---", "Run sc64_deployer with no command (to set a port or remote address)"]
]
...
list_of_options = [
    ...
    ["upload", "--reboot", 0, Types.PATH_GET_LOCATION, "Attempt to reboot the console (requires specific support in the running game)"],
    ["upload", "--save", 1, Types.PATH_GET_LOCATION, "Path to the save file <SAVE>"],
    ...
    ["upload", "--direct", 0, Types.PATH_GET_LOCATION, "Use direct boot mode (skip bootloader)"],
    ["upload", "--no-shadow", 0, Types.PATH_GET_LOCATION, "Do not put last 128 kiB of ROM inside flash memory (can corrupt non EEPROM saves)"],
    ...
    ["upload", "", 0, Types.PATH_GET_LOCATION, "Just upload ROM without any options"],

    ["download", "save", 1, Types.PATH_SET_LOCATION, "Download save and write it to file <PATH>"],
    ...
    ["64dd", "--rom", 1, Types.PATH_GET_LOCATION, "Path to the ROM cartridge file <ROM>"],
    ["64dd", "--save", 1, Types.PATH_GET_LOCATION, "Path to the save file <SAVE> (also used by save writeback mechanism)"],
    ...
    ["debug", "--save", 1, Types.PATH_GET_LOCATION, "Path to the save file <SAVE> (also used by save writeback mechanism)"],
